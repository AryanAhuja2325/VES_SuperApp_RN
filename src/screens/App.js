		...
		<Provider store={store}>
			<NavigationContainer>
				<stack.Navigator>
					...
					<stack.Screen name="DailyAttendance" component={DailyAttendance} options={{ headerShown: false }} />
					<stack.Screen name="EventUpdate" component={EventUpdate} options={{ headerShown: true }} />
					<stack.Screen name="Queries/Feedback" component={Enquiry} options={{ headerShown: false }} />
					<stack.Screen name="Query" component={Query} options={{ headerShown: true }} />
